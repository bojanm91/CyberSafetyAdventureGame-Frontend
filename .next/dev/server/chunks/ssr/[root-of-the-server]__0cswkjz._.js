...
function AuthProvider({ children }) {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (email, password)=>{
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiLogin"])(email, password);
        localStorage.setItem("csag_token", res.accessToken);
        localStorage.setItem("csag_user", JSON.stringify(res.user));
        setToken(res.accessToken);
        setUser(res.user);
    }, []);
    const register = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (username, email, password, confirmPassword)=>{
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiRegister"])(username, email, password, confirmPassword);
        localStorage.setItem("csag_token", res.accessToken);
        localStorage.setItem("csag_user", JSON.stringify(res.user));
        setToken(res.accessToken);
        setUser(res.user);
    ...
    const updateUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((updated)=>{
        setUser(updated);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0cswkjz._.js.map